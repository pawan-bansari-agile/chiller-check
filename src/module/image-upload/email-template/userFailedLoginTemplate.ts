export const userFailedLoginAttemptsTemplate = (
  userFullName: string,
): string => {
  return `<!DOCTYPE html>
<html lang="en">
        ...
        <table style="border: 0;border-spacing: 0;width: 100%;">
                    ...
                    <table style="border: 0;border-spacing:0;">
                        ...
                        <tr>
                            <td style="font-weight: 400;font-size: 16px;color: #101112;line-height: 25px;text-align: center;">
                                Your account has been inactivated due to 3 failed login attempts.
                            </td>
                        </tr>
                    </table>
                </td>
            ...
            <tr>
                <td style="font-weight: 400;font-size: 16px;color: #101112;line-height: 25px;padding-top:15px;text-align: center;">
                    Please contact the our system admin at support@chillercheck.com or reach out to your superior (Company Manager /Facility Manager) to have the account activated back.
                </td>
            </tr>
            <tr>
