export const inquiryTemplate = (mobile_number, logo) =>
  `<!DOCTYPE html>
<html lang="en">
                    ...
                    <tr>
                        <td style="padding: 25px;">
                            <ul style="list-style: none;background: #fff;border-radius: 24px;padding-left: 0;">
                                ...
                                <li style="width: 515px;margin: 0 auto;">
                                    <h3 style="margin: 10px 0;font-size: 25px;color: #1D2939;">New Inquiry submitted from this ${mobile_number} mobile number
                                        </h3>
                                    <div style="width: 500px;margin: 0 auto;border-bottom: 1px solid #E4E9F8;"></div>
                                </li>
                                <li style="width: 515px;margin: 0 auto;">
