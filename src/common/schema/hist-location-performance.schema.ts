...
export type HistFacilityPerformanceDocument = HistFacilityPerformance &
  Document & { createdAt: Date; updatedAt: Date };

@Schema({
  collection: TABLE_NAMES.HIST_FACILITY_PERFORMANCE,
  timestamps: true,
  versionKey: false,
})
export class HistFacilityPerformance {
  @Prop({ type: Types.ObjectId, required: true }) facilityId: Types.ObjectId;
...
export const HistFacilityPerformanceSchema = SchemaFactory.createForClass(
  HistFacilityPerformance,
);
