            ...
            <tr>
                <td style="padding:70px 50px 40px;">
                    <table style="border: 0;border-spacing:0;">
                        ...
                        <tr>
                            <td style="font-weight: 700;font-size: 20px;color: #101112;line-height: 25px;padding-top:15px;">Dear ${staffName},</td>
                        </tr>
                        <tr>
                            <td style="font-weight: 400;font-size: 16px;color: #101112;line-height: 25px;padding-top:15px; ">
                               We are excited to welcome you to Chiller check!
                            </td>
                        </tr>
                         <tr>
                            <td style="font-weight: 400;font-size: 16px;color: #101112;line-height: 25px;padding-top:15px; ">
                                You have been invited to join our team. Please find your login credentials below:
          
                                        <br><br>
                                        <b>Email : <a href="${email}" target="_blank" style="text-decoration: underline; color: blue;">
${email}                                </a>
            ...
            <tr>
                <td style="padding:15px 50px 60px;">
                    <table style="border: 0;border-spacing:0;">
                        <tr>
                            <td style="font-weight: 600;font-size: 17px;color: #404040;line-height: 23px">Thank You, <span
