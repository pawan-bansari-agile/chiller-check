export const reportNotificationTemplate = (
  userFullName: string,
  reportName: string,
  creatorRole: string,
                    ...
                    <table style="border: 0; border-spacing: 0;">
                        ...
                        <tr>
                            <td style="font-weight: 400; font-size: 16px; color: #101112; line-height: 25px; text-align: left;">
                                A report - ${reportName} created by ${creatorRole} - ${creatorFullName} has been shared with you. Click to view the report details.
                            </td>
                        </tr>
                         <tr>
