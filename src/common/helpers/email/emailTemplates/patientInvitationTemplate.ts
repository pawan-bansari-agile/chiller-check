...
<body style="font-family: 'SF Pro Display';font-weight: 400;background-color: #EDEFF2;margin:0;">
    <div style="max-width:800px;margin: 0 auto;background-color: #ffffff;">
        <table style="border: 0;border-spacing: 0;width: 100%;">
            ...
            <tr>
                <td style="padding:70px 50px 40px;">
                    <table style="border: 0;border-spacing:0;">
                    	 <tr>
                            <td style="font-weight: 400;font-size: 20px;color: #101112;line-height: 25px;padding-top:15px;">Welcome to Chiller Check!</td>
                        </tr>
                        <tr>
                            <td style="font-weight: 700;font-size: 20px;color: #101112;line-height: 25px;padding-top:15px;">Dear ${patientName},</td>
                        </tr>
                        <tr>
                            <td style="font-weight: 400;font-size: 16px;color: #101112;line-height: 25px;padding-top:15px; ">
                                We are excited to invite you to join the Chiller Check platform!
                            </td>
                        </tr>
                                    <li>
                                        Sign up and set your password using following details:
                                        <br>
                        ...
                        <tr>
                            <td style="font-weight: 400;font-size: 16px;color: #101112;line-height: 25px;padding-top:15px; ">
                                By joining Chiller check, you'll gain access to a range of health and wellness services designed to support your journey to better health.
                            </td>
                        </tr>
                       <tr>
                            <td style="font-weight: 400; font-size: 16px; color: #101112; line-height: 25px; padding-top: 15px;">
            ...
            <tr>
                <td style="padding:25px 50px 60px;">
                    <table style="border: 0;border-spacing:0;">
                        <tr>
                            <td style="font-weight: 600;font-size: 17px;color: #404040;line-height: 23px;padding-top:15px; ">Thank You, <span
