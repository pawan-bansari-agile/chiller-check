export const freeTrialEndingTemplateForAdminSubAdmin = (
            ...
            <tr>
                <td style="padding:30px 50px 40px;">
                    <table style="border: 0; border-spacing: 0;">
                        ...
                        <tr>
                            <td style="font-weight: 400; font-size: 16px; color: #101112; line-height: 25px; text-align: left;">
                                The free trial of the Company - ${companyName} has ended so the Company Manager - ${managerFullName}'s account has been inactivated.
                            </td>
                        </tr>
                        <tr><td><br/></td></tr>
                        <tr>
                            <td style="font-weight: 400; font-size: 16px; color: #101112; line-height: 25px; text-align: left;">
                                You can activate the account from the user management once you want the company manager to start using the system again after the payment terms are discussed offline.
                            </td>
                        </tr>
                    </table>
                </td>
