export const companyInactivationTemplate = (
  managerFirstName: string,
  role: string,
): string => {
  const supportMessage =
    role === "corporateManager"
      ? "Please reach out to our support team for more details or to reactivate your account."
